...
class SchedulerService {
  ...
  async handleOtherRequest(schedulingData, student) {
    try {
      ...
      if (lowerMessage.includes('הנחה') || lowerMessage.includes('הנחות') || lowerMessage.includes('מבצע') || 
          lowerMessage.includes('זול') || lowerMessage.includes('הוזיל') || lowerMessage.includes('לעשות לי') ||
          lowerMessage.includes('discount')) {
        return {
          success: true,
          message: `${student.getDisplayName()}, מבין אותך לגמרי! 😊\n\n💝 יש לי כמה אפשרויות:\n\n📦 <b>חבילות חסכון:</b>\n• 4 שיעורים - 10% הנחה\n• 8 שיעורים - 15% הנחה\n• 12 שיעורים - 20% הנחה\n\n🎓 <b>הנחות מיוחדות:</b>\n• תלמיד מצטיין - 10%\n• הפניית חבר - 5% לשניכם\n• מקבוצת וואטסאפ המתמטיקה - 7%\n\nבואו נתאם שיעור ניסיון ונדבר על מה שהכי מתאים לך!\n\nבברכה,\nשפיר.`,
          type: 'discount_info'
        };
      }
      ...
      if (lowerMessage.includes('איך') || lowerMessage.includes('מה זה') || lowerMessage.includes('תסביר')) {
        return {
          success: true,
          message: `${student.getDisplayName()}, שמח לענות! 😊\n\n📚 <b>איך זה עובד:</b>\n• אתה אומר לי מתי נוח לך\n• אני מוצא זמן פנוי\n• מתאמים שיעור ב-Zoom\n• מקבלים קישור לפני השיעור\n\n💡 <b>דוגמאות למה לכתוב:</b>\n• "אני רוצה שיעור מחר ב-5"\n• "מה פנוי השבוע?"\n• "בואו נתאם משהו לרביעי"\n\nמה עוד תרצה לדעת?\n\nבברכה,\nשפיר.`,
          type: 'explanation'
        };
      }

      if (lowerMessage.includes('תודה') || lowerMessage.includes('thanks') || lowerMessage.includes('אתה מדהים')) {
        return {
          success: true,
          message: `${student.getDisplayName()}, ממש שמח לעזור! 🤗\n\nהשמחה שלי היא לראות אותך מצליח במתמטיקה.\n\nיש עוד משהו שאני יכול לעזור לך בו?\n\n💡 זכור - אני כאן בשבילך תמיד!\n\nבברכה,\nשפיר.`,
          type: 'appreciation'
        };
      }
